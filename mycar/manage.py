...
from donkeycar.parts.object_detector.green_traffic_detector import GreenTrafficDetector
...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[]):
    ...
    V.add(GreenTrafficDetector(), inputs=['cam/image_array'], outputs=['go']) #détection du feu vert
